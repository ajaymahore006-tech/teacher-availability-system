// PLACE AT: src/pages/StudentDashboard.jsx  (NEW FILE — placeholder, full design port comes next)
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center px-4">
      <div className="bg-white rounded-2xl shadow-xl p-10 max-w-md text-center border border-gray-100">
        <h2 className="text-xl font-bold text-gray-900 mb-2">Student Dashboard</h2>
